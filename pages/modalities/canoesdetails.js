const apiBaseURL = "http://192.168.160.58/Paris2024/api/Canoe_Sprints";
...
$(document).ready(function () {
    ...
    $("#backButton").click(function () {
        window.location.href = "../modalities/canoesprints.html"; // Sempre redireciona para a página canoesprints.html
    });
