var vm = function () {
    ...
    //---Variáveis locais
    var self = this;
    self.baseUri = ko.observable('http://192.168.160.58/Paris2024/api/Teams'); // Atualize a URL conforme necessário
    self.displayName = 'Teams List';
    self.error = ko.observable('');
    self.passingMessage = ko.observable('');
    self.teams = ko.observableArray([]);
    self.currentPage = ko.observable(1);
    self.pagesize = ko.observable(12);  // Alterar para 20 equipes por página
