...
var vm = function () {
    ...
    self.activate = function (id) {
        ...
        var parcDesPrincesLat = 48.8625;
        var parcDesPrincesLon = 2.2875;

        // Criar o ícone para o marcador
        var parcIcon = new L.Icon({
            iconUrl: 'https://cdn-icons-png.flaticon.com/512/25/25613.png', // URL do ícone
            shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
            iconSize: [35, 31],
            iconAnchor: [12, 41],
            popupAnchor: [1, -34],
        ...
        var parcMarker = L.marker([parcDesPrincesLat, parcDesPrincesLon], { icon: parcIcon }).addTo(map);

        // Adicionar um tooltip com o texto "2024 Summer (Paris)" e configurá-lo para aparecer ao passar o mouse
        parcMarker.bindTooltip('2024 Summer (Paris)', {
            permanent: false, // Tooltip aparece apenas quando o mouse está sobre o marcador
            direction: 'top', // Posição acima do marcador
