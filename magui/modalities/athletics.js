...
function loadEvents() {
    ...
    const apiUrl = "http://192.168.160.58/Paris2024/api/Athletics/Events";  // Substitua com o link correto da sua API
...
function displayStages(selectedEvent, eventId) {
    ...
    <tr>
        ...
        <td class="text-end">
            <a class="btn btn-light btn-xs" href="athleticsdetails.html?EventId=${eventId}&StageId=${stage.StageId}">
