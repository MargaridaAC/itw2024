...
Abaixo encontram-se as principais formas de correr o projeto localmente no teu computador. O ponto de entrada principal do projeto é o ficheiro localizado em: `index.html`.
...
3. No explorador de ficheiros do VS Code, navega até `index.html`.
...
4. Abre o teu navegador e acede ao endereço: [http://localhost:8000/index.html](http://localhost:8000/index.html).
...
2. Navega até à pasta do projeto e entra na pasta `homepage`.
